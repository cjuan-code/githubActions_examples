...
const http_client_1 = __nccwpck_require__(8112);
...
const pm = __nccwpck_require__(1267);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(8007);
            }
            const agentOptions = {
...
var parse = __nccwpck_require__(9731);
var enoent = __nccwpck_require__(9339);
...
function spawnSync(command, args, options) {
    ...
    if (!cpSpawnSync) {
        try {
            cpSpawnSync = __nccwpck_require__(3890);  // eslint-disable-line global-require
        } catch (ex) {
            throw new Error(
...
var resolveCommand = __nccwpck_require__(9373);
...
var LRU = __nccwpck_require__(3289);
var resolveCommand = __nccwpck_require__(9373);
var hasBrokenSpawn = __nccwpck_require__(5960);
...
var which = __nccwpck_require__(7840);
var LRU = __nccwpck_require__(3289);
...
module.exports = __nccwpck_require__(68)(exports);
...
function setup(env) {
  ...
  createDebug.humanize = __nccwpck_require__(7633);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
  module.exports = __nccwpck_require__(2774);
} else {
  module.exports = __nccwpck_require__(5119);
}
...
try {
  ...
  var supportsColor = __nccwpck_require__(6086);
...
__nccwpck_require__(3777)(gm.prototype);
__nccwpck_require__(4018)(gm);
__nccwpck_require__(5563)(gm.prototype);
__nccwpck_require__(804)(gm.prototype);
__nccwpck_require__(6153)(gm.prototype);
__nccwpck_require__(5620)(gm.prototype);
__nccwpck_require__(1409)(gm.prototype);
__nccwpck_require__(7505)(gm.prototype);
__nccwpck_require__(5889)(gm.prototype);
...
module.exports.utils = __nccwpck_require__(8925);
module.exports.compare = __nccwpck_require__(1409)();
...
var argsToArray = (__nccwpck_require__(8925).argsToArray);
var isUtil = (__nccwpck_require__(8925).isUtil);
/**
 * Extend proto
 */
...
var spawn = __nccwpck_require__(5698);
var utils = __nccwpck_require__(8925);
var debug = __nccwpck_require__(5586)('gm');
var series = __nccwpck_require__(5497);
...
module.exports = function (proto) {
  __nccwpck_require__(2920)(proto);
  __nccwpck_require__(7162)(proto);
  __nccwpck_require__(9152)(proto);
  __nccwpck_require__(5623)(proto);
}
...
var fs = __nccwpck_require__(7147);
var parallel = __nccwpck_require__(5902);
...
var escape = (__nccwpck_require__(8925).escape);
...
var Map = __nccwpck_require__(6951)
var util = __nccwpck_require__(3837)

// A linked list to keep track of recently-used-ness
var Yallist = __nccwpck_require__(8980)
...
let gm = __nccwpck_require__(8529)
...
var path = __nccwpck_require__(1017)
var COLON = isWindows ? ';' : ':'
var isexe = __nccwpck_require__(299)
